...
const reducer = (state = initialState, action: any) => {
	switch (action.type) {
		case "EDIT_DETAILS":
			...
			newList[index].firstName = action.payload.firstName;
			newList[index].lastName = action.payload.lastName;
			newList[index].email = action.payload.email ?? newList[index].email;
			newList[index].phone = action.payload.phone ?? newList[index].phone;
